...
from .views import (
    ...
    PaymentCompleteView, ConfirmReceiptView, LeaveExchangeView,ConfirmDifferenceView,
)
...
urlpatterns = [
    ...
    path('<int:ticket_id>/confirm-difference/', ConfirmDifferenceView.as_view(), name='confirm-difference'),
